...
$qry = "SELECT * FROM cart WHERE seesion_id='$session_id'";	
    ...
    <section class="checkout spad">
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul>
                                    ...
                                    ?>
                                    <li><?php echo $pro_name; ?>  ( <?php echo $pro_price  ?> x  <?php echo $pro_qty; ?> )
                                    <span>tk
                                         <?php echo $total; ?> /-</span></li>
                                    <?php } ?>
                                </ul>
                                <div class="checkout__order__subtotal">Subtotal <span>
                                    <?php echo $sum; ?> /-tk</span></div>
                                ...
                                <!-- <a type="submit" class="site-btn" name="checkout">PLACE ORDER</a> -->
                                <!-- <a href="order_process.php?s_ID=<?php echo $sid; ?>" name="check">Order Now</a> -->
                                <a href="order_process.php?session_id=<?php echo $session_id; ?>" name="check" class="site-btn">Order Now</a>
                            </div>
                        </div>
            ...
            <?php  }
                ...
                <p class="text-danger text-center" style="font-size: 30px;">No Data Found</p>
