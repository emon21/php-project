...
if (isset($_GET['cat_edit'])) {
   ...
   $product_edit =  $_GET['cat_edit'];
    ...
    $sql ="SELECT * FROM catagory WHERE slug='$product_edit'";
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary">
              ...
              <form action="category_edit_process.php" method="post" enctype="multipart/form-data">
                 <input type="hidden" name="category_edit" value="<?php echo $getData['slug'] ?>">
                <div class="card-body">
                  ...
                  <div>
                   ...
                   <div class="form-group col-sm-4">
                    ...
                    <img src="products/<?php echo $getData['catagory_img'] ?>" alt="" width="120" height="80">
